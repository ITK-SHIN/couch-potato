              ...
              <div key={index} className={`flex flex-col lg:flex-row items-center gap-12 ${index % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}>
                ...
                <div className="flex-1 space-y-6">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      <h3 className="text-3xl font-black text-black">{process.title}</h3>
                      <p className="text-lg text-gray-600 font-medium">{process.subtitle}</p>
                    </div>
                  </div>
                  ...
                  <div className="inline-flex items-center gap-2 bg-gray-100 px-4 py-2 rounded-full">
                    ...
                    <span className="font-semibold text-gray-800">소요시간: {process.duration}</span>
                  </div>
                </div>
                  ...
                  <div className={`w-5/12 ${index % 2 === 0 ? 'pr-8 text-right' : 'pl-8 text-left'}`}>
                    <div className="bg-white rounded-xl p-6 shadow-lg">
                      <div className="flex items-center gap-3 mb-3">
                        <span className="text-2xl">{process.icon}</span>
                        <h3 className="text-xl font-bold text-black">{process.title}</h3>
                      </div>
