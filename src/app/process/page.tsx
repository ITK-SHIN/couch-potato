      ...
      <main className="relative min-h-screen bg-black overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 md:pt-36 lg:pt-20 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <SmallYellowHoverBigBtn href="#process-steps" text="📋 제작 단계 보기" />    
            </div>
          </div>
        </div>
      </main>
      ...
      <section className="py-24 bg-gradient-to-r from-potato-orange to-potato-orange-light text-black">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            <SmallYellowHoverBigBtn href="/contact" text="🚀 프로젝트 상담하기" />
            <SmallYellowBorderHoverBigBtn href="/portfolio" text="🎬 포트폴리오 보기" />
          </div>
        </div>
      </section>
    </>
